  	...
  	$.fn.lightshow = function(options) {
	    ...
	    function button_next_click(content) {
	    	if(!content.find('li').is(':animated'))
	    	{
	        	...
	        	{
	          		case "fade":
	            		first.fadeOut(settings.animation);
	            	...
	            	break;
	          		...
	          		case "slide":
	            		first.animate({ left: "-100%" }, settings.animation, function() { $(this).css("left", "0").hide(); });
    	...
    	this.each(function() {
      		...
      		content.addClass("lightshow-content");
...
/*			
			// circles - not ready yet
      		if(settings.circles) {
        		...
        		circles.find("li").click(function() {
